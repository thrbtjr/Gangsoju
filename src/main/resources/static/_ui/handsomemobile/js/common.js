...
var quickSTagSwiperOption = {
  ...
  quickSBrandTagSelector =
    ".hand_footer_gnb_wrap #tab_01 .flag_wrap.swiper-container",
  quickSBrandTagSwiper = null,
  quickSCaterogyTagSelector =
    ".hand_footer_gnb_wrap #tab_02 .flag_wrap.swiper-container",
  quickSCaterogyTagSwiper = null,
  quickSSmartTagSelector =
    ".hand_footer_gnb_wrap #tab_03 .flag_wrap.swiper-container",
...
(function ($) {
  $(document).ready(function () {
    ...
    $(".hsome_quickMenu a, .main202103-look-ahead.more a").click(function () {
      ...
      if (
        $page_url.indexOf("layout_") != -1 ||
        $(this).parent().index() == 0 ||
        $(this).parent().index() == 5 ||
        $(this).parent().index() == 6
      ) {
        //샵, 마이페이지 퀵메뉴 클릭하면 해당 화면 로딩 180802 수정
    ...
    quickSBrandTagSwiper = new Swiper(
      quickSBrandTagSelector,
      quickSTagSwiperOption
    );
    quickSCaterogyTagSwiper = new Swiper(
      quickSCaterogyTagSelector,
      quickSTagSwiperOption
    );
    quickSSmartTagSwiper = new Swiper(
      quickSSmartTagSelector,
      quickSTagSwiperOption
    );
        ...
        success: function (data) {
          setTimeout(function () {
            ...
            var myheartSwiperClass =
              ".hand_footer_gnb_wrap .hs_product_list .img_slide_wrap.active.swiper-container";
    ...
    $(document).on("click", ".ui_tab li a", function () {
      ...
      if (
        $(".product-style-pop ul.style_codi").hasClass("size02") &&
        $this_parent.find(".fcs").length == 0
      ) {
        $this_parent.append('<li class="fcs"></li>');
        $(".hs_red_border_tab.ui_tab.active li.on:first-child a").css(
          "border-color",
          "transparent"
        );
        $append_cnt = 0;
      ...
      if ($append_cnt == 0 && $this_parent.find(".fcs").length == 0) {
        //180802 수정
        $this_parent.append('<li class="fcs"></li>');
        $append_cnt = 1;
      }
      ...
      if (
        $this.parents("div").hasClass("hand_footer_gnb_wrap2002") &&
        $this.attr("href") == "#tab_01"
      ) {
    ...
    $(document).on("click", ".shop_cont .one_link", function () {
      if ($(this).parent(".one_wrap").siblings().is(".two_depth")) {
        if ($(this).parent(".one_wrap").parent("li").hasClass("on")) {
          ...
          $(".brd_shop_cate_wrap2002")
            .find(".one_depth")
            .find("li")
            .removeClass("disable");
        } else {
          if ($(this).parents("div").hasClass("brd_shop_cate_wrap2002")) {
            // 200213 lnb 수정
            $(".brd_shop_cate_wrap2002")
              .find(".one_depth")
              .find("li")
        ...
        $(this)
          .parents(".shop_cont")
          .find(".two_depth, .three_depth, .four_depth, .five_depth")
          .slideUp(300); //181001 수정(1뎁스 메뉴 클릭했을 때 하위메뉴 닫힘)
        $(this)
          .parents(".shop_cont")
          .find(".one_depth .on .two_depth")
          .slideDown(300);
    ...
    $(document).on("click", ".shop_cont .two_link.js-brand-link", function () {
      // two depth 브랜드 샵
      var $this = $(this);
    ...
    $(document).on("click", ".shop_cont .two_link.js-cate-link", function () {
      // two depth 카테고리 샵
      if ($(this).siblings().is(".three_depth")) {
        ...
        $(this)
          .parents(".shop_cont")
          .find(".three_depth, .four_depth, .five_depth")
          .slideUp(300); //181001 수정(2뎁스 메뉴 클릭했을 때 하위메뉴 닫힘)
        $(this)
          .parents(".shop_cont")
          .find(".two_depth .on .three_depth")
          .slideDown(300);
    ...
    $(document).on("click", ".shop_cont .three_link", function () {
      //3뎁스 메뉴의 하위 메뉴가 있을 때에만 실행
      if ($(this).siblings().is(".four_depth")) {
        ...
        $(this)
          .parents(".shop_cont")
          .find(".four_depth, .five_depth")
          .stop(false, true)
          .slideUp(300);
        $(this)
          .parents(".shop_cont")
          .find(".three_depth .on .four_depth")
          .stop(false, true)
          .slideDown(300);
    ...
    $(document).on("click", ".shop_cont .four_link", function () {
      //4뎁스 메뉴의 하위 메뉴가 있을 때에만 실행
    ...
    /*smart_pop*/
    $(document).on("click", ".smart_top .filter_link", function () {
      //180615 수정
      $(".smart_pop").show();
      $(".smart_wrap").hide();
    ...
    $(document).on(
      "click",
      ".smart_pop .smart_check_btn .check_btn, .hand_footer_gnb_wrap a.pre",
      function () {
        //180615 수정
        $(".smart_pop").hide();
        $(".smart_wrap").show();
    ...
    if (handsomeUserLoginYn == "Y") {
      $(document).on(
        "click",
        ".hand_footer_gnb_wrap .shop_cont .shop_list_brand .like",
        function () {
          var $this = $(this);
          ...
          if (!$(this).hasClass("on")) {
            ...
            $appended_html =
              '<li class="swiper-slide flag" data-idx=' +
              $(this).closest(".shop_list_brand").index() +
              ">" +
              '<a href="#" class="name">' +
              $brand +
              "</a>" +
            ...
            //200221 하트애니메이션 추가 - s
            $active_heart =
              '<span class="active_heart" style="top:' +
              ($(this).closest(".one_lists").offset().top + 13.5) +
              "px;left:" +
              $(this).closest(".one_lists").offset().left +
              'px;"></span>';
            $(".brd_shop_cate_wrap2002").append($active_heart);
            $(".active_heart").animate(
              {
                top: $(".ico_heart200214").offset().top,
                left: $(".ico_heart200214").offset().left,
              },
              200,
              function () {
                $(this).remove();
            ...
            //200213 lnb 수정
            $(".brd_shop_cate_wrap2002 .my_heart_flag2002")
              .find(".white_action200219")
              .stop()
              .show();
            setTimeout(function () {
              $(".brd_shop_cate_wrap2002 .my_heart_flag2002").addClass(
                "add_like2002"
              );
            }, 300);
            setTimeout(function () {
              $(".brd_shop_cate_wrap2002 .my_heart_flag2002")
                ...
                .stop()
                .hide();
              $(".brd_shop_cate_wrap2002 .my_heart_flag2002").removeClass(
                "add_like2002"
              );
            }, 800);
          } else {
            ...
            $(
              quickSBrandTagSelector +
                " ul li input[name=" +
                $this.closest(".one_lists").index().toString() +
                "]"
            )
              .parent()
              .removeClass("active");
            setTimeout(function () {
              quickSBrandTagSwiper.removeSlide(
                $(
                  quickSBrandTagSelector +
                    " ul li input[name=" +
                    $this.closest(".one_lists").index().toString() +
    ...
    $(document).on(
      "click",
      quickSBrandTagSelector + " ul .delete",
      function () {
        //200213 lnb 수정
        var $parent = $(this).parent();
        $(".hand_footer_gnb_wrap .shop_cont .shop_list_brand")
          .eq($parent.attr("data-idx"))
          .find(".one_lists")
          .eq($parent.find("input").attr("name") * 1)
          .find(".like")
          .removeClass("on");
    ...
    if (handsomeUserLoginYn == "Y") {
      $(document).on(
        "click",
        ".hand_footer_gnb_wrap .shop_cont .shop_list_category .like",
        function () {
          if (!processYn) {
            processYn = true;
            var $this = $(this);
...
if ($this.closest('.one_lists').index() == 0) {
  ...
  $category_appended_html = 	'<li class="flag swiper-slide ' + $category_1dth + '">' +
              ...
              $active_heart =
                '<span class="active_heart" style="top:' +
                ($(this).closest(".three_lists").offset().top + 13.5) +
                "px;left:" +
                $(this).closest(".three_lists").offset().left +
                'px;"></span>';
              $(".cate_shop_cate_wrap2004").append($active_heart);
              $(".active_heart").animate(
                {
                  top: $(".flag_fixed_wrap2004 .ico_heart200214").offset().top,
                  left: $(".flag_fixed_wrap2004 .ico_heart200214").offset()
                    .left,
                },
                200,
                function () {
              ...
              //200410 lnb 수정
              $(".cate_shop_cate_wrap2004 .my_heart_flag2002")
                .find(".white_action200219")
                .stop()
                .show();
              setTimeout(function () {
                $(".cate_shop_cate_wrap2004 .my_heart_flag2002").addClass(
                  "add_like2002"
                );
              }, 300);
              setTimeout(function () {
                $(".cate_shop_cate_wrap2004 .my_heart_flag2002")
                  ...
                  .stop()
                  .hide();
                $(".cate_shop_cate_wrap2004 .my_heart_flag2002").removeClass(
                  "add_like2002"
                );
              }, 800);
            } else {
...
*/
    ...
    $(document).on(
      "click",
      ".hand_footer_gnb_wrap .shop_cont .smart_wrap .smart_list ul[class*=check_list] li[class*=check] input",
      function () {
        var $this = $(this);
        ...
        if ($this.prop("checked")) {
          ...
          $(
            ".hand_footer_gnb_wrap .shop_cont .smart_wrap .smart_check_btn"
          ).addClass("active"); //180615 수정

          switch (
            $(
              ".hand_footer_gnb_wrap .shop_cont .smart_wrap .smart_list .left_tab li.on"
            ).index()
          ) {
            case 0:
              $smart_category_1dth = "woman";
              break;
            case 1:
              $smart_category_1dth = "man";
              break;
            case 2:
              $smart_category_1dth = "life";
              break;
            default:
              $smart_category_1dth = "";
              break;
          ...
          $(
            ...
            .removeClass("active");
          setTimeout(function () {
            quickSSmartTagSwiper.removeSlide(
              $(
                quickSSmartTagSelector +
                  " ul li input[name=" +
                  (
    ...
    $(document).on(
      "click",
      ".hand_footer_gnb_wrap .red_border_tab li:nth-child(3) a",
      function () {
        //SMART 탭 클릭하면 상품 갯수 카운팅 애니메이션 시작 180719 수정
        jQuery({
          someValue:
            $(
              ".hand_footer_gnb_wrap .shop_cont .smart_wrap .smart_top .filter_num"
            ).text() * 1,
        }).animate(
          { someValue: $("#nextSmartTotalCount").val() },
          {
            duration: 1000,
            ...
            step: function () {
              ...
              $(
                ".hand_footer_gnb_wrap .shop_cont .smart_wrap .smart_top .filter_num"
              ).text(Math.floor(this.someValue));
            },
            complete: function () {
              $("#smartTotalCount").text($("#nextSmartTotalCount").val());
            },
          }
        );
      }
    ...
    $(document).on(
      "click",
      ".hand_footer_gnb_wrap .hs_product_list li .chk_mark input",
      function () {
        if ($(this).is(":checked")) {
    ...
    $(document).on(
      "click",
      ".hand_footer_gnb_wrap .hs_product_list .info_cont .color_chip .chip",
      function () {
        $chipId = $(this).attr("id");
        $activeSlide = $(this)
          .parents("li")
    ...
    var mypage_card_swiper = new Swiper(
      ".mypage_card_container.swiper-container",
      mypage_opts
    );
    ...
    function initMypage() {
      ...
      if ($(".mypage_card_container.swiper-container").length > 0) {
        mypage_card_swiper.on("slideChange", function () {
          var $current_slide = $(
            ".mypage_card_container.swiper-container .swiper-slide"
          ).eq(mypage_card_swiper.activeIndex);
          ...
          $(".hand_footer_gnb_wrap.mypage .red_border_tab li").removeClass(
            "on"
          );
          $(".mpg_card_indicator1903 .swiper-pagination-bullet").removeClass(
            "swiper-pagination-bullet-active"
          );
          if ($order != -1) {
            $(".hand_footer_gnb_wrap.mypage .red_border_tab li")
              .eq(0)
              .addClass("on");
          ...
          mypage_card_tab_focus(
            $(".hand_footer_gnb_wrap.mypage .red_border_tab li.on a")
          ); //180725 edit
      ...
      //180725 edit start
      if (
        $(".hand_footer_gnb_wrap.mypage").length > 0 &&
        window.sessionStorage.getItem("mypage_index") == null
      ) {
      ...
      $(document).on(
        "click",
        ".hand_footer_gnb_wrap.mypage .red_border_tab li a",
        function () {
          //180830 index 수정
          mypage_card_swiper.slideTo(
            $(".mypage_card_container.swiper-container .swiper-slide").index(
              $(
                ".mypage_card_container.swiper-container .swiper-slide." +
                  $(this).attr("class") +
                  ".start"
    ...
    var befActiveTab = "";
    function mypage_card_tab_focus($that) {
      //180725 add

      window.sessionStorage.setItem(
        "mypage_index",
        mypage_card_swiper.activeIndex
      );
      ...
      if (
        $this_parent.prevObject[0].attributes["tab"].textContent != befActiveTab
      ) {
        try {
          ga("gp.send", "pageview", {
            ...
            location:
              ...
              "?mypage_tab=" +
              $this_parent.prevObject[0].attributes["tab"].textContent, //가상페이지URL
    ...
    function eChartMypage(customerGradeId, colorC, value) {
      if (document.getElementById(customerGradeId) !== null) {
        ...
        var searchChart = echarts.init(
          document.getElementById(customerGradeId)
        );
    ...
    $(document).on(
      "click",
      ".mypage_card_container .grade_stage.front .s-circle a",
      function () {
        //나의 회원등급 혜택 보기
    ...
    $(document).on(
      "click",
      ".mypage_card_container .grade_stage.back .s-bt a",
      function () {
        //온라인 회원 등급 보기
    ...
    $(document).on(
      "click",
      ".mypage_card_container .s-grade-wrapper .s-grade span",
      function () {
        //나의 회원등급 혜택 토글링 180811 추가
        $(this).siblings().removeClass("on");
        $(this).addClass("on");
        $(this)
          .closest(".s-grade-wrapper")
          .find(".s-guide-toggle ul")
          .removeClass("on");
        $(this)
          .closest(".s-grade-wrapper")
          .find(".s-guide-toggle ul")
...
function handleChange(el) {
  //타이틀 영역의 셀렉트 박스
  document.querySelector(".hsome_header .selected_text span").innerHTML =
    el.value;
}
